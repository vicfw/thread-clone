...
const PostCard = ({ item, isReply, _id: postId, replies }: Props) => {
            ...
            onPress={() => {
              router.push({
                ...
                params: {
                  ...
                  postId: (postId as string) ?? item._id,
                },
              });
            }}
          >
          ...
          <View className="pl-[50px] pt-4 flex-row">
            ...
            <TouchableOpacity
              onPress={() =>
                item.likes.length !== 0 &&
                router.push({
                  pathname: "/postLikeCard",
                  params: { item: item.likes },
                })
              }
            >
              <Text className="text-[16px[ text-[#0000009b]">
